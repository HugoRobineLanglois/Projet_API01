...
<tr>
	...
	%>
			<tr>
				...
				<td>
					<a href="AdminServlet?action=supprimer&id=<%=a.getAdresse()%>">Supprimer</a>
					<a href="AdminServlet?action=modifier&id=<%=a.getAdresse()%>">Modifier</a>	
				</td>
			</tr>
	<%
			}
